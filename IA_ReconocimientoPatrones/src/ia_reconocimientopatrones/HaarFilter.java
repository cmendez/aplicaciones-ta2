...
public class HaarFilter {
     ...
     * applied during a call to the
     * <code>filter</code> method. This cannot exceed ln2(size). This maximum
     * forms the sensible default value and can be specified by passing a
     * negative number to this method.
     *
     ...
     * arithmetic on
     * <code>int</code>s the number of fractional bits cannot exceed 23. The
     * sensible default value for the number of fractional bits is twice the
     * number of iterations; this default can be specified by passing a negative
     * number to this method.
     *
     * @param fractionalBits the number of binary fractional bits in the number
     ...
     *
     * If the
     * <code>iterations</code> and
     * <code>fractionalBits</code> parameters of this object have been modified
     * since the filter was created then the data will not be faithfully
     * reconstructed. If the number of fractional bits is less than its default
     * value then the inversion may be imperfect due to accumulated rounding
     * errors.
     *
     ...
     * <code>BufferedImage</code>. If the
